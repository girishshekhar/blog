...
summary: >
  Most Principal Engineers try to scale by doing more of what already works.
  That approach breaks down when your scope jumps from 50 engineers to 5,000.
  This post introduces the step-function mental model for PE growth and the
  Three-Position Framework for managing the outsized influence your voice
  carries at this level.
tags: ["principal-engineering", "staff-plus", "leadership", "influence", "career-growth", "mental-models"]
